...
namespace XHD.CRM.Data
{
    ...
    public class CRM_product_category : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            {
                DataSet ds = ccpc.GetList(" ISNULL(isDelete,0)=0 ");
            ...
            if (request["Action"] == "AdvanceDelete")
            {
                ...
                {
                    bool isdel = ccpc.AdvanceDelete(int.Parse(c_id), 1, DateTime.Now.ToString(StaticStr.yyyy_MM_dd_HH_mm_ss));
                    if (isdel)
                    {
                        //日志
            ...
            if (request["Action"] == "regain")
            {
                ...
                {
                    ccpc.AdvanceDelete(int.Parse(arr[i]), 0, DateTime.Now.ToString(StaticStr.yyyy_MM_dd_HH_mm_ss));
                }
