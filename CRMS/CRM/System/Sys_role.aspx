    ...
    <title></title>
        ...
        <script type="text/javascript">
            ...
            function authorized() {
                ...
                if (row) {
                    top.$.ligerDialog.open({ width: 800, height: 500, url: 'System/Sys_Role_authorized.aspx?Role_id=' + row.RoleID, title: "授权", buttons: [
                        {
            ...
            function role_emp() {
                ...
                var row = manager.getSelectedRow();
                if (row) {
                    top.$.ligerDialog.open({ width: 700, height: 500, url: 'system/Role_emp.aspx?rid=' + row.RoleID, title: "角色人员管理", buttons: [
            ...
            function data_authorized() {
                ...
                var row = manager.getSelectedRow();
                if (row) {
                    top.$.ligerDialog.open({ width: 600, height: 300, url: 'system/Sys_data_authorized.aspx?rid=' + row.RoleID, title: "数据权限管理", buttons: [
                        { text: '确定', onclick: f_importOK },
                        { text: '取消', onclick: f_importCancel }
                    ]
                    });
