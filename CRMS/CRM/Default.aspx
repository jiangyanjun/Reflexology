...
<head>
    ...
    <script type="text/javascript">
        ...
        function toolbar() {
            ...
            var toolbarscript = "var toolbar = new Toolbar({renderTo: 'filters', items: [";
            toolbarscript += "],";
            toolbarscript += "filters: [";
            toolbarscript += "    {";
            toolbarscript += "        id: 'filter-home',";
            toolbarscript += "        title: '桌面',";
            toolbarscript += "        bodyStyle: 'filter-home',";
            toolbarscript += "        handler: function () {";
            toolbarscript += "            f_addTab('home')";
            toolbarscript += "        }";
            toolbarscript += "    }, {";             
            toolbarscript += "        id: 'filter-sett',";
            toolbarscript += "        title: '个人设置',";
            toolbarscript += "        bodyStyle: 'filter-sett',";
            toolbarscript += "        handler: function () {";
            toolbarscript += "            changepwd()";
            toolbarscript += "        }";
            toolbarscript += "    }, {";
          
            toolbarscript += "        id: 'filter-out',";
            toolbarscript += "        title: '退出系统',";
            toolbarscript += "        bodyStyle: 'filter-out',";
            toolbarscript += "        handler: function () {";
            toolbarscript += "            logout()";
            toolbarscript += "        }";
            toolbarscript += "    }]";
            toolbarscript += "}); ";
            toolbarscript += "toolbar.render();";
            eval(toolbarscript);
        }
    ...
    <form id="form1">
        ...
        <div style="background: #d2e2f2; height: 74px; overflow: hidden;">
            <div style="height: 47px; margin: 0; padding: 0;">
                <div style="width: 278px; float: left;">
                   <a href="http://www.yjyrj.com" target="_blank">  <img id="logo" alt="" src="Images/logo/xhd.png" style="height: 42px; margin-left: 5px; margin-top: 2px;" />   </a>
                </div>
                ...
                <div style="float: right; width: 220px; height: 47px; margin-right: 65px;">
                    <div style="width: 100%; height: 25px; text-align: right;">
                        <table style="width: 100%;">
                            <tr>
                                <td>
                                    <div id="jnkc" style="font-size: 12px; color: black; text-align: right; height: 24px; line-height: 24px;" />
                                </td>
                            </tr>
                        </table>
                    </div>
                ...
                <div id="portrait">
                    ...
                    <img src="a.gif" onerror="noheadimg()" />
                </div>
            </div>
        ...
        <div id="layout1" style="width: 100%">
            ...
            <div position="bottom">
                ...
                <a href="http://www.yjyrj.com" target="_blank">小黄豆软件</a> QQ:250476029
                <div style="width: 235px;height:29px; float: right;">
                        <iframe id="baiduframe" marginwidth="0" marginheight="0" scrolling="no" framespacing="0" vspace="0" hspace="0" frameborder="0" width="230" height="29" src="baidu.html"></iframe>
