    ...
    public class MyOpaqueLayer : System.Windows.Forms.Control
    {
        ...
        public MyOpaqueLayer(int Alpha, bool IsShowLoadingImage)
        {
            ...
            if (IsShowLoadingImage)
            {
                ...
                //pictureBox_Loading.Image = DCScrapTool.Properties.Resources.loading;
                pictureBox_Loading.Image = Resources.load;// Image.FromFile(@System.AppDomain.CurrentDomain.BaseDirectory + "\\Image\\load.gif");
