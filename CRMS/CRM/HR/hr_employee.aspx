...
<head>
    ...
    <script type="text/javascript">
        ...
        function add() {
            f_openWindow("hr/hr_employee_add.aspx", "新增账号", 680, 430);
        }
        ...
        function edit() {
            ...
            var row = manager.getSelectedRow();
            if (row) {
                f_openWindow('hr/hr_employee_add.aspx?empid=' + row.ID, "修改账号", 680, 430);
            } else {
                $.ligerDialog.warn('请选择行！');
            }
        }
                    ...
                    if (issave) {
                        ...
                        $.ajax({
                            ...
                            success: function (responseText) {
                                ...
                                if (responseText == "regsitefull") {
                                    $.ligerDialog.closeWaitting();
                                    $.ligerDialog.warn("新增失败，系统不能超过注册人数！");
