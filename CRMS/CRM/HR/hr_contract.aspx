...
<head>
    ...
    <script type="text/javascript">
        ...
        function edit() {
            ...
            var row = manager.getSelectedRow();
            if (row) {
                //$.get("../../data/sys_data_authority.ashx?Action=getauth&authid=1&authtype=Sys_edit&crmid=" + row.id + "&rnd=" + Math.random(), function (data, textStatus) {
                //    //alert(data);
                //    if (data == "true")
                ...
                //    });
                //    //f_openWindow('CRM/Customer_add.aspx?cid=' + row.id, "修改客户", 770, 490);
                //} else {
        ...
        function del() {
            ...
            var row = manager.getSelectedRow();
            if (row) {
                //$.get("../../data/sys_data_authority.ashx?Action=getauth&authid=1&authtype=Sys_del&crmid=" + row.id + "&rnd=" + Math.random(), function (data, textStatus) {
                //    //alert(data);
                //    if (data == "true") {
