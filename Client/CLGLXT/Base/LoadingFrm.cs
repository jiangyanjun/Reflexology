   ...
   public partial class LoadingFrm : Form
    {
        ...
        public LoadingFrm()
        {
            ...
            Initialize(null,int.MaxValue, waitMessage, cancelEnable, timerVisable);
        }
        public LoadingFrm(EventHandler<EventArgs> method, int maxWaitTime, string waitMessage, bool cancelEnable, bool timerVisable)
        {
            maxWaitTime *= 1000;
            Initialize(method, maxWaitTime, waitMessage, cancelEnable, timerVisable);
        }
        public LoadingFrm(EventHandler<EventArgs> method)
        {
        ...
        public LoadingFrm(EventHandler<EventArgs> method, string waitMessage)
        {
            int maxWaitTime = 60 * 1000;
            bool cancelEnable = true;
            bool timerVisable = true;
        ...
        public LoadingFrm(EventHandler<EventArgs> method, bool cancelEnable, bool timerVisable)
        {
            int maxWaitTime = 60 * 1000;
            string waitMessage = "正在处理数据，请稍后...";
            Initialize(method, maxWaitTime, waitMessage, cancelEnable, timerVisable);
        ...
        private void LoadingFrm_Shown(object sender, EventArgs e)
        {
        ...
        private void LoadingFrm_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (FormEffectEnable)
            {
                if (this.Opacity >= 1)
